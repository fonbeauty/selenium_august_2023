...
def test_explicit(driver):
    ...
    button = driver.find_element(By.ID, "reveal")
    button.click()
    ...
    revealed.is_selected()
    # long_string = 'Displayed'*5000
    # driver.execute_script(f'document.getElementById("revealed").value="{long_string}"')
